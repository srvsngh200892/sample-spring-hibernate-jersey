...
public class UserResource {
	...
	public User get(@PathParam("userId") Long userId) {
		// Handles GET on /Users/{UserId}. Returns a single User for the given
		// UserId.
	...
	public Response create(User user,
		...
		// Handles POST on /Users. Creates a new User and adds it into an
		// repository.
	...
	public User update(User user, @PathParam("userId") Long userId) {
		// Handles PUT on /Users/UserId. Updates the existing User with the new
		// values.
	...
	public User delete(@PathParam("userId") Long userId) {
		// Handles DELETE on /Users/UserId. Deletes the existing User and
		// returns the same.
